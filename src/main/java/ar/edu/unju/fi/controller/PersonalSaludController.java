...
public class PersonalSaludController {
	...
	@GetMapping("/personaldeSalud/editar/{id}")
	...
	@GetMapping("/personaldeSalud/eliminar/{id}")
	...
	public String selectPersonalSalud(@PathVariable Integer id, Model model) {
		...
		model.addAttribute("personalSalud", persSalud);
		model.addAttribute("mensajeElim", msjElim);
	...
	public String filtrarPersonalSalud(@RequestParam(name = "apellido") String apellido, Model model,@ModelAttribute PersonalSalud personalSalud) {

		model.addAttribute("personalSalud", personalSaludService.getPersonalSalud());
		model.addAttribute("allPersonalSalud",
				personalSaludService.searchPersonalSalud(apellido, personalSalud.getRol().getNombreRol()));
